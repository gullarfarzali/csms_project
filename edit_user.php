...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE users SET first_name=?, last_name=?, password_hash=?, email=?, date_of_birth=? WHERE user_id = ?";
...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="edit_user_s.css" />
  </head>
  <body>
    <!-- Navbar -->
    <nav
    ...
    <div class="container">
      <div class="register">
        <h2 class="updateUser">Update <span>User</span></h2>
